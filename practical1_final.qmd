...
```{r pressure 12, echo=FALSE}
# Set the working directory if needed, then source the script
source(file.path("data", "Practical 1", "garchAuto.R"))

# Fit an ARMA model to the negative log returns
...
# Fit a GARCH(1,1) model to the ARMA residuals using the garchAuto() function
...
checkresiduals(garch_model_sp500)
checkresiduals(garch_model_cac40)
```
