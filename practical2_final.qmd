...
```{r venice1, echo=FALSE, warning=FALSE}
library(VGAM)
data(venice90)
...
```{r venice2, echo=FALSE, warning=FALSE}
# Fit linear model
...
```{r venice3, echo=FALSE, warning=FALSE}
...
```{r venice4, echo=FALSE, warning=FALSE}
...
```{r venice5, echo=FALSE, warning=FALSE}
...
```{r venice6, echo=FALSE, warning=FALSE}
...
```{r venice7, echo=FALSE, warning=FALSE}
...
```{r nuclear1, echo=FALSE, warning=FALSE}
# Load the Rdata file
...
```{r nuclear2, echo=FALSE, warning=FALSE}
...
```{r nuclear3, echo=FALSE, warning=FALSE}
...
```{r nuclear4, echo=FALSE, warning=FALSE}
...
```{r nuclear5, echo=FALSE, warning=FALSE}
# Fit GPD model
...
```{r lausanne1, echo=FALSE, warning=FALSE}
# Read the CSV files
...
```{r lausanne2, echo=FALSE, warning=FALSE}
...
```{r lausanne3, echo=FALSE, warning=FALSE}
...
```{r lausanne4, echo=FALSE, warning=FALSE}
...
```{r lausanne5, echo=FALSE, warning=FALSE}
summary_list <- list(
